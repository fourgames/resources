<!-- Generated from resources.yml and README.template.md by `npm run build`. Edit those instead. -->
...
AI makes game development accessible to more people. For me personally, it raises the quality of my work while saving time, but good results still take constant iteration and playtesting. `godot-ai` lets Claude read and edit your open Godot project directly: scenes, nodes, scripts and more.
...
Readable UI text and clear icons do a lot of heavy lifting. Grab ready-made fonts and icons here, or make your own pixel font.
...
> [!NOTE]
> Screenshots are refreshed automatically every day. Want to suggest a resource? See [CONTRIBUTING.md](CONTRIBUTING.md).
